...
const Nav = ({ location, site, children, logo }) => (
  <MasterLayout siteMetadata={site.siteMetadata} id="layout">
    <TopNav siteMetadata={site.siteMetadata} location={location} logo={logo} />
    {children}
    <section className="footer">
      <div className="container content has-text-centered">
        <p className="copyright has-text-thirdary">
          ...
          {` `}
          <a
            className="copyright has-text-thirdary"
...
Heart.defaultProps = { height: "25px", width: "25px", fill: "blue" };
